import { ActionRowBuilder, ApplicationCommandData, ApplicationCommandType, ChatInputCommandInteraction, GuildMember, ModalBuilder, ModalSubmitInteraction, PermissionsString, TextInputBuilder, TextInputStyle } from 'discord.js';
...
export class AccessKeyCommand implements Command {
    ...
    public async execute(intr: ChatInputCommandInteraction, data: EventData): Promise<void> {
        ...
        const firstActionRow = new ActionRowBuilder<TextInputBuilder>().addComponents(keyInput);
